defmodule Navatrack.Accounts.UserPlanLink do
  use Ash.Resource,
    otp_app: :navatrack,
  ...
  relationships do
    ...
    belongs_to :plan, Navatrack.Works.Plan, primary_key?: true, allow_nil?: false
  end
  ...
  def fab!(map \\ %{}) do
    ...
    map = Map.put_new_lazy(map, :plan_id, fn -> Navatrack.Works.Plan.fab!().id end)
