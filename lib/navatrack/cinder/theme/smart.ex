defmodule Cinder.Themes.Smart do
  @moduledoc """
  A smart theme with minimal spacing, high density, full width, and no filter
  labels, all for maximum information display. Similar to the Cinder theme "compact".
  ...
  component Cinder.Components.Table do
    ...
    set :th_class,
        "py-2 text-sm text-gray-700 text-left whitespace-nowrap border-b border-gray-300"
