defmodule Navatrack.Works.Aim.Actions do
  ...
  actions do
    ...
    default_accept [
      ...
      :mean_lead_time_for_changes_expect,
      ...
      :failed_deployment_recovery_time_expect,
