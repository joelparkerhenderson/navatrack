defmodule NavatrackWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NavatrackWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NavatrackWeb.Gettext, "errors", msg, opts)
    end
  end
