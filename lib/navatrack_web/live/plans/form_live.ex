defmodule NavatrackWeb.Plans.FormLive do
      ...
      >
        ...
        <.section id="steeple" title="STEEPLE: Social Technological Economic Environmental Political Legal Ethical">
          ...
          <.input
            ...
            type="textarea"
            label="Environmental"
            placeholder="Environmental considerations, regulations, climate change, weather, ecological aspects, carbon footprint, sustainability plans"
          />
          <.input
