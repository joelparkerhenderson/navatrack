defmodule NavatrackWeb.MeasurementUnits.IndexLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app {assigns}>
      ...
      <Cinder.Table.table theme={Cinder.Themes.Smart} resource={X}>
        ...
        <:col :let={x} field="category" label="Category" sort search>{x.category}</:col>
        <:col :let={x} field="synonyms" label="Synonyms" sort search>{x.synonyms}</:col>
      </Cinder.Table.table>
    </Layouts.app>
    """
  end
