defmodule NavatrackWeb.AccessPermissions.ShowLive do
    ...
    <Layouts.app {assigns}>
      <.header>
        ...
        <:actions>
          ...
          <.button navigate={~p"/access_permissions/#{@x.id}/edit"}>
            Edit
          </.button>
        </:actions>
      </.header>
      <main>
        <ul>
          ...
          <li>
            <strong>Access Operation Id:</strong>
            <%= @x.access_operation_id %>
          </li>
        </ul>
      </main>
    </Layouts.app>
