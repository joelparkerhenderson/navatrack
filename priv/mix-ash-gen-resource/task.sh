...
touch priv/repo/migrations/00000000000000_create_tasks
...
touch test/navatrack_web/live/tasks/form_live.ex
touch test/navatrack_web/live/tasks/index_live.ex
touch test/navatrack_web/live/tasks/show_live.ex
