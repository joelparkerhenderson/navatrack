defmodule Navatrack.Repo.Migrations.CreateTableTopics do
  ...
  def up do
    ...
    CREATE TABLE topics (
      ...
      --- net_promoter_score
      net_promoter_score_customer_perspective_actual_value numeric(7,2),
      net_promoter_score_customer_perspective_target_value numeric(7,2),
      net_promoter_score_customer_perspective_unit text,
      net_promoter_score_customer_perspective_description_as_markdown text,
      net_promoter_score_user_perspective_actual_value numeric(7,2),
      net_promoter_score_user_perspective_target_value numeric(7,2),
      net_promoter_score_user_perspective_unit text,
      net_promoter_score_user_perspective_description_as_markdown text,
      net_promoter_score_worker_perspective_actual_value numeric(7,2),
      net_promoter_score_worker_perspective_target_value numeric(7,2),
      net_promoter_score_worker_perspective_unit text,
      net_promoter_score_worker_perspective_description_as_markdown text,
      --- active_users
      active_users_actual_value numeric(7,2),
      active_users_target_value numeric(7,2),
      active_users_unit text,
      active_users_description text,
      --- uptime_percentage
      uptime_percentage_actual_value numeric(7,5),
      uptime_percentage_target_value numeric(7,5),
      uptime_percentage_unit text,
      uptime_percentage_description text,
      --- burn_rate
      burn_rate_net_cash_per_week_actual_value numeric(7,2),
      burn_rate_net_cash_per_week_target_value numeric(7,2),
      burn_rate_net_cash_per_week_unit text,
      burn_rate_net_cash_per_week_description text,
      burn_rate_hours_per_week_actual_value numeric(7,2),
      burn_rate_hours_per_week_target_value numeric(7,2),
      ...
      deployment_frequency_actual_value numeric(7,2),
      deployment_frequency_target_value numeric(7,2),
      deployment_frequency_ratio numeric(7,2) GENERATED ALWAYS AS (deployment_frequency_actual_value / deployment_frequency_target_value) STORED,
      deployment_frequency_unit text,
      deployment_frequency_description text,
      --- lead_time_for_changes
      lead_time_for_changes_actual_value numeric(7,2),
      lead_time_for_changes_target_value numeric(7,2),
      lead_time_for_changes_ratio numeric(7,2) GENERATED ALWAYS AS (lead_time_for_changes_actual_value / lead_time_for_changes_target_value) STORED,
      lead_time_for_changes_unit text,
      lead_time_for_changes_description text,
      --- change_failure_rate
      change_failure_rate_actual_value numeric(7,2),
      change_failure_rate_target_value numeric(7,2),
      change_failure_rate_ratio numeric(7,2) GENERATED ALWAYS AS (change_failure_rate_actual_value / change_failure_rate_target_value) STORED,
      change_failure_rate_unit text,
      change_failure_rate_description text,
      --- mean_time_to_recovery
      mean_time_to_recovery_actual_value numeric(7,2),
      mean_time_to_recovery_target_value numeric(7,2),
      mean_time_to_recovery_ratio numeric(7,2) GENERATED ALWAYS AS (mean_time_to_recovery_actual_value / mean_time_to_recovery_target_value) STORED,
      mean_time_to_recovery_unit text,
      mean_time_to_recovery_description text,
      --- maintainability_index
      maintainability_index_actual_value numeric(7,2),
      maintainability_index_target_value numeric(7,2),
      maintainability_index_ratio numeric(7,2) GENERATED ALWAYS AS (maintainability_index_actual_value / maintainability_index_target_value) STORED,
      maintainability_index_unit text,
      maintainability_index_description text,
      --- line_count
      line_count_actual_value numeric(7,2),
      line_count_target_value numeric(7,2),
      line_count_ratio numeric(7,2) GENERATED ALWAYS AS (line_count_actual_value / line_count_target_value) STORED,
      line_count_unit text,
      line_count_description text,
      --- test_automation_code_coverage
      test_automation_code_coverage_actual_value numeric(7,2),
      test_automation_code_coverage_target_value numeric(7,2),
      test_automation_code_coverage_ratio numeric(7,2) GENERATED ALWAYS AS (test_automation_code_coverage_actual_value / test_automation_code_coverage_target_value) STORED,
      test_automation_code_coverage_unit text,
      test_automation_code_coverage_description text,
      --- halstead_complexity_volume
      halstead_complexity_volume_actual_value numeric(7,2),
      halstead_complexity_volume_target_value numeric(7,2),
      halstead_complexity_volume_ratio numeric(7,2) GENERATED ALWAYS AS (halstead_complexity_volume_actual_value / halstead_complexity_volume_target_value) STORED,
      halstead_complexity_volume_unit text,
      halstead_complexity_volume_description text,
      --- halstead_complexity_difficulty
      halstead_complexity_difficulty_actual_value numeric(7,2),
      halstead_complexity_difficulty_target_value numeric(7,2),
      halstead_complexity_difficulty_ratio numeric(7,2) GENERATED ALWAYS AS (halstead_complexity_difficulty_actual_value / halstead_complexity_difficulty_target_value) STORED,
      halstead_complexity_difficulty_unit text,
      halstead_complexity_difficulty_description text,
      --- halstead_complexity_effort
      halstead_complexity_effort_actual_value numeric(7,2),
      halstead_complexity_effort_target_value numeric(7,2),
      halstead_complexity_effort_ratio numeric(7,2) GENERATED ALWAYS AS (halstead_complexity_effort_actual_value / halstead_complexity_effort_target_value) STORED,
    ...
    execute "CREATE INDEX topics_location_longitude_as_decimal_degrees_index on topics (location_latitude_as_decimal_degrees);"
  ...
  def down do
    ...
    execute "DROP INDEX IF EXISTS topics_location_iso_3166_2;"
    execute "DROP INDEX IF EXISTS topics_location_postal_code;"
    execute "DROP INDEX IF EXISTS topics_location_latitude_as_decimal_degrees;"
    execute "DROP INDEX IF EXISTS topics_location_longitude_as_decimal_degrees;"
