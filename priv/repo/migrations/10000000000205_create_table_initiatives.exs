defmodule Navatrack.Repo.Migrations.CreateTableInitiatives do
  ...
  def up do
    ...
    CREATE TABLE initiatives (
      ...
      net_promoter_score_customer_perspective_actual_value DECIMAL,
      net_promoter_score_customer_perspective_target_value DECIMAL,
      net_promoter_score_customer_perspective_unit text,
      net_promoter_score_customer_perspective_description_as_markdown text,
      --- user_net_promoter
      net_promoter_score_user_perspective_actual_value DECIMAL,
      net_promoter_score_user_perspective_target_value DECIMAL,
      net_promoter_score_user_perspective_unit text,
      net_promoter_score_user_perspective_description_as_markdown text,
      --- worker_net_promoter
      net_promoter_score_worker_perspective_actual_value DECIMAL,
      net_promoter_score_worker_perspective_target_value DECIMAL,
