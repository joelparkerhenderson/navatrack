defmodule Navatrack.Repo.Migrations.CreateTableUserIloIsco2008Links do
  ...
  def up do
    ...
    CREATE TABLE user_ilo_isco_2008_links (
      ...
      ilo_isco_2008_id uuid REFERENCES ilo_isco_2008s(id) ON DELETE SET NULL,
      status text,
      tagging text
    );
    """
    ...
    execute "CREATE INDEX user_ilo_isco_2008_links_retired_at_index ON user_ilo_isco_2008_links (retired_at);"
  ...
  def down do
    ...
    execute "DROP INDEX IF EXISTS user_ilo_isco_2008_links_retired_at_index;"
