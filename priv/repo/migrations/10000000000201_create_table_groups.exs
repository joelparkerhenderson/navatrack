defmodule Navatrack.Repo.Migrations.CreateTableGroups do
  ...
  def up do
    ...
    execute "CREATE INDEX groups_location_longitude_as_decimal_degrees_index on groups (location_latitude_as_decimal_degrees);"
  ...
  def down do
    ...
    execute "DROP INDEX IF EXISTS groups_location_iso_3166_2;"
    execute "DROP INDEX IF EXISTS groups_location_postal_code;"
    execute "DROP INDEX IF EXISTS groups_location_latitude_as_decimal_degrees;"
    execute "DROP INDEX IF EXISTS groups_location_longitude_as_decimal_degrees;"
