defmodule Navatrack.Repo.Migrations.CreateTableEvents do
  ...
  def up do
    ...
    CREATE TABLE events (
      ...
      locale_code text,
      parent_id uuid CONSTRAINT parent_id_fk REFERENCES events (id),
    ...
    execute "CREATE INDEX events_location_longitude_as_decimal_degrees_index on events (location_latitude_as_decimal_degrees);"
  ...
  def down do
    ...
    execute "DROP INDEX IF EXISTS events_location_iso_3166_2;"
    execute "DROP INDEX IF EXISTS events_location_postal_code;"
    execute "DROP INDEX IF EXISTS events_location_latitude_as_decimal_degrees;"
    execute "DROP INDEX IF EXISTS events_location_longitude_as_decimal_degrees;"
