defmodule Navatrack.Repo.Migrations.CreateTablePlans do
  ...
  def up do
    ...
    execute "CREATE INDEX plans_location_longitude_as_decimal_degrees_index on plans (location_latitude_as_decimal_degrees);"
  ...
  def down do
    ...
    execute "DROP INDEX IF EXISTS plans_location_iso_3166_2;"
    execute "DROP INDEX IF EXISTS plans_location_postal_code;"
    execute "DROP INDEX IF EXISTS plans_location_latitude_as_decimal_degrees;"
    execute "DROP INDEX IF EXISTS plans_location_longitude_as_decimal_degrees;"
