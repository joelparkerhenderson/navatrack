defmodule Navatrack.Repo.Migrations.CreateTablePlans do
  @moduledoc """
  Create table plans.
  """
  ...
  def up do
    ...
    CREATE TABLE plans (
      ...
      locale_code text,
      parent_id uuid CONSTRAINT parent_id_fk REFERENCES plans (id),
    ...
    execute "CREATE INDEX plans_updated_at_index ON plans (updated_at);"
    execute "CREATE INDEX plans_deleted_at_index ON plans (deleted_at);"
    execute "CREATE INDEX plans_locale_code_index ON plans (locale_code);"
    execute "CREATE INDEX plans_name_index ON plans (name);"
    execute "CREATE INDEX plans_name_index_tpo ON plans (name text_pattern_ops);"
    execute "CREATE INDEX plans_tagging_index ON plans (tagging);"
    execute "CREATE INDEX plans_tagging_index_tpo ON plans (tagging text_pattern_ops);"
    execute "CREATE INDEX plans_location_iso_3166_1_alpha_2_index on plans (location_iso_3166_1_alpha_2 );"
    execute "CREATE INDEX plans_location_iso_3166_2_index on plans (location_iso_3166_2);"
    execute "CREATE INDEX plans_location_postal_code_index on plans (location_postal_code);"
    execute "CREATE INDEX plans_location_latitude_as_decimal_degrees_index on plans (location_latitude_as_decimal_degrees);"
    execute "CREATE INDEX plans_location_longitude_as_decimal_degrees_index on plans (location_longitude_as_decimal_degrees);"
    execute "CREATE INDEX plans_gs1_digital_link_index ON plans (gs1_digital_link);"
    execute "CREATE INDEX plans_gs1_country_code_index ON plans (gs1_country_code);"
    execute "CREATE INDEX plans_gs1_global_location_number_index ON plans (gs1_global_location_number);"
    execute "CREATE INDEX plans_isic_v4_code_index ON plans (isic_v4_code);"
  end
  ...
  def down do
    ...
    execute "DROP INDEX IF EXISTS plans_tagging_index_tpo;"
    execute "DROP INDEX IF EXISTS plans_location_iso_3166_1_alpha_2_index;"
    execute "DROP INDEX IF EXISTS plans_location_iso_3166_2_index;"
    execute "DROP INDEX IF EXISTS plans_location_postal_code_index;"
    execute "DROP INDEX IF EXISTS plans_location_latitude_as_decimal_degrees_index;"
    execute "DROP INDEX IF EXISTS plans_location_longitude_as_decimal_degrees_index;"
    execute "DROP INDEX IF EXISTS plans_gs1_digital_link_index;"
    execute "DROP INDEX IF EXISTS plans_gs1_country_code_index;"
    execute "DROP INDEX IF EXISTS plans_gs1_global_location_number_index;"
    execute "DROP INDEX IF EXISTS plans_isic_v4_code_index;"
