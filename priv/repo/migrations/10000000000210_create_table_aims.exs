defmodule Navatrack.Repo.Migrations.CreateTablePlans do
  ...
  def up do
    ...
    execute "CREATE INDEX plans_tagging_index ON aims (tagging);"
    execute "CREATE INDEX plans_tagging_index_tpo ON aims (tagging text_pattern_ops);"
    execute "CREATE INDEX plans_location_iso_3166_1_alpha_2_index on aims (location_iso_3166_1_alpha_2 );"
    execute "CREATE INDEX plans_location_iso_3166_2_index on aims (location_iso_3166_2);"
    execute "CREATE INDEX plans_location_postal_code_index on aims (location_postal_code);"
    execute "CREATE INDEX plans_location_latitude_as_decimal_degrees_index on aims (location_latitude_as_decimal_degrees);"
    execute "CREATE INDEX plans_location_longitude_as_decimal_degrees_index on aims (location_longitude_as_decimal_degrees);"
    execute "CREATE INDEX plans_gs1_digital_link_index ON aims (gs1_digital_link);"
    execute "CREATE INDEX plans_gs1_country_code_index ON aims (gs1_country_code);"
    execute "CREATE INDEX plans_gs1_global_location_number_index ON aims (gs1_global_location_number);"
    execute "CREATE INDEX plans_isic_v4_code_index ON aims (isic_v4_code);"
  end
  ...
  def down do
    ...
    execute "DROP TABLE IF EXISTS aims;"
  end
end
