defmodule Navatrack.Repo.Migrations.CreateTableTasks do
  ...
  def up do
    ...
    execute "CREATE INDEX tasks_location_longitude_as_decimal_degrees_index on tasks (location_latitude_as_decimal_degrees);"
  ...
  def down do
    ...
    execute "DROP INDEX IF EXISTS tasks_location_iso_3166_2;"
    execute "DROP INDEX IF EXISTS tasks_location_postal_code;"
    execute "DROP INDEX IF EXISTS tasks_location_latitude_as_decimal_degrees;"
    execute "DROP INDEX IF EXISTS tasks_location_longitude_as_decimal_degrees;"
