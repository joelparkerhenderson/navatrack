defmodule Navatrack.Repo.Migrations.CreateTableAccessOperations do
  ...
  def up do
    ...
    execute "CREATE INDEX access_operations_retired_at_index ON access_operations (retired_at);"
  ...
  def down do
    ...
    execute "DROP INDEX IF EXISTS access_operations_retired_at_index;"
