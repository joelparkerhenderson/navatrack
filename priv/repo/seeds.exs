...
Code.require_file("seeds/currency/seeds.exs", __DIR__)
Code.require_file("seeds/measurement_system/seeds.exs", __DIR__)
Code.require_file("seeds/measurement_unit/seeds.exs", __DIR__)
