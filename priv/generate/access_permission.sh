...
export app=navatrack
export Dom=Works
export Resource=AccessPermission
export resource=access_permission
export Resources=AccessPermissions
export resources=access_permissions
...
mix ash.gen.resource \
    ...
    --extend postgres \
    --uuid-primary-key id \
    --relationship belongs_to:access_attribute_id:$App.$Dom.AccessAttribute \
    --relationship belongs_to:access_operation_id:$App.$Dom.AccessOperation \
